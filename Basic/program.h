...
/*
 * Method: print_list
 * Usage: program.print_list();
 * -----------------------
 * Print the source line in numerical sequence.
 */
...
private:
    ...
    struct program_line {
        string original_source_line;
        Statement *parsed_representation = nullptr;
    };
    
    map<int, program_line> program_body;
};
